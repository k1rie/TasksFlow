...
import {deleteFaceStudent,searchFaceStudent,registerFaceStudent,createStudent,getStudents,getStudent, deleteStudent, updateStudent, attendenceStudent, getAttendenceStudent, createPermission, getPermissions, createAttendance, sendQR,getStudentByName,getAllStudentsGrades,sendMessageToStudent} from "../controllers/students.controller.js"
...
router.get("/getAllStudentsGrades/:groupId",getAllStudentsGrades)

router.post("/sendMessage",sendMessageToStudent)
